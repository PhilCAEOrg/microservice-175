...
@ServicePath("res")
@ManualDeployment
public class TestResource extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "175", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg/microservice-175/blob/master/LICENSE.txt") ) )
  @Path("/")
  public static class RootResource {

    private final TestResource service = (TestResource) Context.getCurrent().getService();
